...
public class DocumentDAO implements IDocumentDAO {
	...
	public int add(Document document) {
		...
		try {
			connection = new MySQLConnection().getConnection();
			preparedStatement = connection.prepareStatement("INSERT INTO document(`name`, `description`, `upload_date`, `request_id`) VALUES (?, ?, ?, ?)");
			...
			preparedStatement.setInt(4, document.getRequestId());
	...
	public int edit(Document document) {
		...
		try {
			...
			preparedStatement = connection.prepareStatement(
					"UPDATE document SET name = ?, description = ?, upload_date = ?, request_id = ? WHERE id = ?");
